...
type
  TForm1 = class(TForm)
    ...
    procedure chkTFClick(Sender: TObject);
...
procedure TForm1.chkTFClick(Sender: TObject);
begin
  MainForm.Saved_TestForever := chkTF.Checked;
end;

procedure TForm1.chkHSClick(Sender: TObject);
begin
  MainForm.Saved_HighlightSpeed := chkHS.Checked;
end;
